...
export const Header: React.FC<HeaderProps> = memo(({ onMenuToggle, isSidebarOpen }) => {
  return (
    <header className="bg-gray-50 dark:bg-gray-950 text-gray-800 dark:text-white px-4 flex items-center sticky top-0 z-30 border-gray-50 border-black/5 dark:border-gray-950 h-[65px]">
      ...
      <div className="flex-1 text-center min-w-0 px-2">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">Developed by R&D K12</p>
      </div>
