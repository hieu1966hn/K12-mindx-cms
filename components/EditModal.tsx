...
const commonInputClass = "w-full px-4 py-3 border border-gray-300/80 dark:border-gray-600/80 rounded-lg bg-gray-50/80 dark:bg-gray-700/60 text-gray-900 dark:text-gray-200 focus:border-[#E31F26] focus:ring-0 outline-none transition";
        ...
        switch(type) {
            case 'course': return (
                <>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{UI_STRINGS.imageUrl}</label>
                        <div className="mt-2 flex items-center gap-4">
                            ...
                            <label htmlFor="image-upload" className="cursor-pointer bg-white dark:bg-gray-700 py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-8 w-full max-w-2xl m-4 relative animate-fade-in-up" onMouseDown={e => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-end gap-4 mt-8">
                        <button type="button" onClick={onClose} className="py-2 px-5 rounded-md bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 transition-colors font-semibold focus:outline-none focus:ring-0">{UI_STRINGS.cancel}</button>
                        <button type="submit" className="py-2 px-5 rounded-md bg-[#E31F26] text-white font-bold hover:bg-red-700 transition-colors shadow-lg shadow-red-500/20 focus:outline-none focus:ring-0">{UI_STRINGS.save}</button>
                    </div>
                </form>
            </div>
        </div>
